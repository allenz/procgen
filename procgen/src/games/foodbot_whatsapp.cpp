...
// Foodbot variant with different test set
const std::string NAME = "foodbot_whatsapp";
...
class FoodBotWhatsAppGame : public BasicAbstractGame {
  public:
    float min_dim = 0.0f;
    ...
    void asset_for_type(int type, std::vector<std::string> &names) override {
        if (type == PLAYER) {
            ...
            if(options.test_theme || options.restrict_themes) {
                names.push_back("whatsapp/1f400.png");
                names.push_back("whatsapp/1f402.png");
                names.push_back("whatsapp/1f405.png");
                // names.push_back("whatsapp/1f955.png");
                // names.push_back("whatsapp/1f966.png");
                // names.push_back("whatsapp/1f994.png");
            } else {
                fassert(false);
            }
        } else if (type == GOOD_OBJ) {
            if(options.test_theme || options.restrict_themes) {
                names.push_back("whatsapp/1f33d.png");
                names.push_back("whatsapp/1f344.png");
                names.push_back("whatsapp/1f345.png");
                // names.push_back("whatsapp/1f352.png");
                // names.push_back("whatsapp/1f407.png");
                // names.push_back("whatsapp/1f416.png");
            } else {
                fassert(false);
            }
...
REGISTER_GAME(NAME, FoodBotWhatsAppGame);
